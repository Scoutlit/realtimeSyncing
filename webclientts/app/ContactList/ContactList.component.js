System.register(['angular2/core', 'angular2/http', '../ContactElement/ContactElement.component', 'angular2/router', '../services/ContactManagerService'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, ContactElement_component_1, router_1, ContactManagerService_1;
    var ContactList;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            ContactList = (function () {
                function ContactList(http, contactMananger) {
                    this.http = http;
                ...
                ContactList = __decorate([
                    ...
                    __metadata('design:paramtypes', [http_1.Http, ContactManagerService_1.ContactManagerService])
                ], ContactList);
                return ContactList;
            }());
